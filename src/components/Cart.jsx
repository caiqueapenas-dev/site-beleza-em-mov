...
function Cart({ isOpen, onClose, cartItems = [], onCheckout, onIncreaseQuantity, onDecreaseQuantity, onRemoveItem }) {
    ...
    return (
        ...
        <div onClick={onClose} className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-end animate-fade-in">
